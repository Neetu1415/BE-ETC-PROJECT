...
# # Configuration
# CONFIG = {
#     'log_interval_minutes': 5,  # Changed from 10 to 1 for more frequent updates
#     'violation_threshold': 3,
#     'default_rtsp_url': "rtsp://admin:GECGATE@321@172.28.0.95:554/stream",
#     'send_email_alerts': True,
#     'admin_email': 'admin@example.com',
...
#                                 f"This facility is not currently booked."
#                             )
#                             # Reset violation count after sending alert
#                             alert.violation_count = 0
#                             logger.info(f"Alert sent and violation count reset for {sports_complex}")
#                     alert.save()
#                 else:
#                     # Create new alert with violation count 1
#                     FacilityAlert.objects.create(
...
#     # Keep only the last 30 minutes of data (assuming 10-minute intervals)
#     existing_data = existing_data[-30:]  # Increased from 3 to 30 to keep more history

...
class InfiniteDataLoader(torch.utils.data.dataloader.DataLoader):
    ...
    def __init__(self, *args, **kwargs):  # Corrected method name
        ...
        object._setattr_(self, 'batch_sampler', _RepeatSampler(self.batch_sampler))
...
class _RepeatSampler(object):
    ...
    def __init__(self, sampler):  # Corrected method name
...
class LoadImages:  # for inference
    def __init__(self, path, img_size=640, stride=32):  # Corrected method name
...
class LoadWebcam:  # for inference
    def __init__(self, pipe='0', img_size=640, stride=32):  # Corrected method name
        self.img_size = img_size
        self.stride = stride
...
class LoadStreams:  # multiple IP or RTSP cameras
    def __init__(self, sources='sources.txt', img_size=640, stride=32):  # Corrected method name
        self.mode = 'stream'
        self.img_size = img_size
        self.stride = stride
...
class Albumentations:
    ...
    def _call_(self, im, labels, p=1.0):
